...
const Services = () => {
  return (
    <div className="">
      ...
      {/*  */}
      <ScrollAnimation animateIn="animate__animated animate__lightSpeedInRight">
        {" "}
        <div className="md:flex px-5 md:px-0 gap-5 m-auto max-w-[70rem]  animate__animated animate__fadeInLeft">
          <a
        ...
        {/*  */}
        <div className="mt-5 md:flex px-5 md:px-0 gap-5 m-auto max-w-[70rem]  animate__animated animate__fadeInLeft">
          <a
            className="flex flex-col group bg-white border shadow-sm rounded-xl overflow-hidden hover:shadow-lg transition dark:bg-gray-800 dark:border-gray-700 dark:shadow-slate-700/[.7]"
            href="#"
          >
          ...
          >
            ...
            <div className="p-4 md:p-5">
              <h3 className="text-lg font-bold text-gray-800 dark:text-white">
                Quran & Azan with different excents
              </h3>
              <p className="mt-1 text-gray-800 dark:text-gray-400">
                Some quick example text to build on the card title and make up
                the bulk of the card's content.
